...
import dev.solocoding.shorterurl.service.impl.UrlServiceImpl;
...
class UrlServiceTest {
    ...
    void shouldSaveUrl() {
        ...
        when(repo.save(entity)).thenReturn(getShortUrlStub());
    ...
    void shouldDeleteWhenUrlIsFound() {
        ObjectId id = getShortUrlStub().getId();
        when(repo.findById(id)).thenReturn(Optional.of(getShortUrlStub()));
